...
namespace FinanceApp.Controllers
{
    public class AcoountsController : Controller
    {
        ...
        public AcoountsController(AppDbContext context)
        {
            _context = context;
        }
